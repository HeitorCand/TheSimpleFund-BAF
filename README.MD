...
- A **demo script** that clearly shows the user action and resulting on-chain state.
- At least one **explorer link** per flow to verify correctness and transparency.
