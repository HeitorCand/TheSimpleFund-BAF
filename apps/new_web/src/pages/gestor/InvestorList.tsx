...
const InvestorList: React.FC = () => {
    ...
    if (loading) return <div className="text-center p-8">Loading investors...</div>;

    return (
        <div className="bg-white p-6 rounded-lg shadow-soft">
            <h2 className="text-xl font-semibold mb-4">Manage Investors</h2>
            <div className="space-y-4">
                {investidores.length === 0 ? (
                    <p className="text-center text-gray-500 py-8">No investors found.</p>
                ) : (
